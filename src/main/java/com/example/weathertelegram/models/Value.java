...
public class Value {
    ...
    public static final String COMMAND_CONDITIONS_BONUS_CODE = "Получи бонус код " +
            "за каждое выполненное условие!" +
            " \n" +
            "\n\n \u26A1 Подпишись на наш телеграм: @thebattleclub \n" +
            " \u26A1 Подпишись на наш инстаграм: bit.ly/Instagram_Lineage2_TheBattleClub \n\n" +
            "\nПризы уже ждут тебя\uD83C\uDF81\uD83C\uDF81\uD83C\uDF81";
    public static final String COMMAND_GET_COUNT_USERS = "Получить количество пользователей с базы данных";
    public static final String COMMAND_GET_SUPPORT = "Получить онлайн-поддержку\uD83E\uDDDD\u200D\u2642\uFE0F";
    public static final String COMMAND_GET_BONUS_CODE = "Получить бонус-код\uD83E\uDD11";
    public static final String COMMAND_I_DID_CONDITIONS_TELEGRAM = "Я подписался на Телеграм  @thebattleclub\u2705";
    public static final String COMMAND_I_DID_CONDITIONS_INSTAGRAM = "Я подписался на Инстаграм @thebattleclub \u2705";
    ...
    public static final String COMMAND_1_FORM = "Текст";
